...
class BiometricVC: UIViewController {
    ...
    func setUIElementsProperties() {
        ...
        self.startBtn.titleLabel?.font = UIFont.init(name: AppRobotoFontMedium, size: fontSizeStart ?? 18.0)
        ...
        self.skipBtn.titleLabel?.font = UIFont.init(name: AppRobotoFontMedium, size: fontSizeSkip ?? 18.0)
        ...
        DispatchQueue.main.async {
            ...
            if BioMetricAuthenticator.canAuthenticate() {
                ...
                if BioMetricAuthenticator.shared.faceIDAvailable() {
                    ...
                    self.subHeading1Lbl.text = ""
                    self.subHeading1Lbl.font = UIFont.init(name: AppRobotoFontRegular, size: self.subHeading1Lbl.font.pointSize)
                    self.subHeading2Lbl.text = self.getLocalizatioStringValue(key: "Authenticate with Touch Id/ Face Id of your phone")
                    self.subHeading2Lbl.font = UIFont.init(name: AppRobotoFontRegular, size: self.subHeading2Lbl.font.pointSize)
